...
function Privacy() {
  return (
    <Container>
      ...
      <p>
        This privacy notice for bukizz (doing business as bukizz) ("we," "us,"
      ...
      <ul>
        ...
        <li>
          ...
          messages, storage, social media accounts, reminders, calendar, camera,
          microphone, and other features. If you wish to change our access or
      ...
      <ul>
        ...
        <li>
          ...
          Google Analytics Advertising Features that we may use include: Google
        ...
        <li>
          ...
          API). We obtain and store on your device ("cache") your location. You
        ...
        <li>
          ...
          https://app.termly.io/dashboard/website/757ea52a-cb71-4b6d-a17e-353f73f7bf8c/privacy-policy
          6/8 or other items to users in return for the acceptance and
          completion of an advertisement offer. Such an offer wall may appear in
          our application(s) and be displayed to you based on certain data, such
          as your geographic area or demographic information. When you click on
          an offer wall, you will be brought to an external website belonging to
      ...
      <h1>4. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h1>
      <p>
      ...
      <p>
        ...
        require us keeping your personal information for longer than four (4)
      ...
      <p>
        ...
        advertising by advertisers on our Services.If you have questions or
      ...
      <p>
        ...
        enquirybukizz@gmail.com or contact us by post at:
      </p>
      <p>bukizz</p>
      <p>------------</p>
      <p>------------</p>
      ...
      <p>
        ...
        submit a data subject access request. This privacy policy was created
