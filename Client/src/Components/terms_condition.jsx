...
function Terms_condition() {
  return (
    <Container>
      ...
      <p>
        We are bukizz ("Company," "we," "us," "our"), a company registered in
        India at MOHAN VILA APARTMENT, GEETA NAGAR, KANPUR, Uttar Pradesh
        208025.
      </p>
      <p>
        We operate the website bukizz.com (the "Site"), the mobile application
        bukizz (the "App"), as well as any other related products and services
        that refer or link to these legal terms (the "Legal Terms")
        (collectively, the "Services").
      </p>
      <p>
        You can contact us by phone at 09369467134, email at
        bukizzstore@gmail.com, or by mail to MOHAN VILA APARTMENT, GEETA NAGAR,
        KANPUR, Uttar Pradesh 208025, India.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and bukizz,
      ...
      <ul>
        ...
        <li>12. MOBILE APPLICATION LICENSE</li>
        <li>13. ADVERTISERS</li>
      ...
      <h1>Our intellectual property</h1>
      <p>
      ...
      <p>
        ...
        address your request to: bukizzstore@gmail.com. If we ever grant you the
      ...
      <h1>Your submissions and contributions</h1>
      <p>
      ...
      <p>
        ...
        change prices at any time. All payments shall be in Rupees .
      </p>
      <p>
      ...
      <h1>11. GUIDELINES FOR REVIEWS</h1>
      <p>
      ...
      <h1>12. MOBILE APPLICATION LICENSE</h1>
      <h1>Use License</h1>
      <p>
      ...
      <h1>Apple and Android Devices</h1>
      <p>
      ...
      <h1>17. MODIFICATIONS AND INTERRUPTIONS</h1>
      <p>
      ...
      <p>
        ny dispute arising out of or in connection with these Legal Terms,
        ...
        be two (2). The seat, or legal place, or arbitration shall be KANPUR,
        India. The language of the proceedings shall be hindi/english. The
        governing law of these Legal Terms shall be substantive law of India.
      </p>
      <h1>Restrictions</h1>
      <p>
        he Parties agree that any arbitration shall be limited to the Dispute
      ...
      <h1>22. LIMITATIONS OF LIABILITY</h1>
      <p>
      ...
      <h1>25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h1>
      <p>
